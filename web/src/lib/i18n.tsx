...
const dict: Record<Lang, Record<string, string>> = {
  zh: {
    "nav.home": "欢迎", "nav.start": "定制计划", "nav.docs": "了解GAP", "nav.training": "我的能力", "nav.cta": "定制计划",
    ...
    "step.1.t": "选择目标运动", "step.1.d": "2–6 项运动与优先级",
    ...
    "dash.viewPlan": "查看完整计划", "dash.reassess": "复测", "dash.adjust": "调整目标",
    "plan.title": "训练计划", "plan.back": "返回仪表盘",
  },
  en: {
    "nav.home": "Welcome", "nav.start": "Custom Plan", "nav.docs": "About GAP", "nav.training": "My Abilities", "nav.cta": "Custom Plan",
    ...
    "step.1.t": "Choose sports", "step.1.d": "2–6 sports with priorities",
    ...
    "ob.step2.sub": "Choose 2–6 sports you want to develop.",
    ...
    "dash.viewPlan": "View full plan", "dash.reassess": "Re-assess", "dash.adjust": "Adjust goals",
